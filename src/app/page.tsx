                            ...
                            <div className="flex flex-row lg:flex-col gap-3 justify-center lg:justify-start flex-wrap">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`px-5 py-3 rounded-xl text-sm font-semibold tracking-wide border text-left transition-all duration-300 ${activeSolutionTab === tab.id
                        ...
                        <div className="flex gap-2">
                            {testimonials.map((_, idx) => (
                                <span
                                    ...
                                    className={`w-2.5 h-2.5 rounded-full cursor-pointer transition-all duration-300 ${currentTestimonial === idx ? "bg-brand-cyan w-6" : "bg-white/20 hover:bg-white/40"
                                        }`}
                                />
                            ))}
                        </div>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div
                            key={idx}
                            className={`glass-card rounded-3xl p-8 relative flex flex-col justify-between overflow-hidden ${tier.popular ? "border-2 border-brand-cyan/60 scale-[1.03] shadow-lg shadow-brand-cyan/5" : ""
                                }`}
                        >
                            {tier.popular && (
                            ...
                            <div className="pt-8">
                                <Link
                                    ...
                                    className={`w-full inline-flex items-center justify-center py-3.5 px-6 rounded-xl font-bold text-sm tracking-wide transition-all ${tier.popular
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, idx) => (
                            ...
                            >
                                ...
                                <div
                                    className={`transition-all duration-300 overflow-hidden ${openFaq === idx ? "max-h-[300px] border-t border-white/5" : "max-h-0"
                                        }`}
                                >
