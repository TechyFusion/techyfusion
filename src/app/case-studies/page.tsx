    ...
    <div className="relative min-h-screen pb-20">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        {caseStudies.map((study, idx) => (
          <div key={idx} className="glass-card rounded-3xl p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/5">
                <div>
                  <span className="text-[10px] text-slate-400 font-extrabold uppercase tracking-widest bg-white/5 border border-white/10 px-2.5 py-1 rounded-lg">
                    {study.industry}
                  </span>
                  <h2 className="text-2xl font-bold text-white mt-3">{study.company}</h2>
                </div>
                <div className="flex flex-wrap gap-4 text-xs font-bold text-slate-300">
                  <div className="bg-slate-900 border border-white/5 px-4 py-2.5 rounded-2xl flex items-center gap-1.5">
              ...
              {/* Title banner */}
              <h3 className="text-xl md:text-2xl font-extrabold text-brand-cyan leading-snug">
                {study.title}
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                {/* Result */}
                <div className="space-y-3 bg-white/5 border border-white/5 p-5.5 rounded-2xl">
                  <h4 className="text-xs font-extrabold text-slate-400 uppercase tracking-widest flex items-center gap-2">
                  ...
                  <div className="pt-3 flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-white">{study.metrics}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
        <div className="glass-card rounded-3xl p-8 md:p-12 text-center space-y-6 relative overflow-hidden">
          ...
          <h2 className="text-3xl font-extrabold text-white">Let&apos;s Replicate These Results for You</h2>
