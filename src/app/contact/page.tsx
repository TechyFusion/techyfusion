    ...
    <div className="relative min-h-screen pb-20">
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="space-y-6 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-semibold text-brand-pink tracking-wide">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="glass-card rounded-3xl p-8 space-y-6">
              ...
              <ul className="space-y-6 text-sm text-slate-300">
                <li className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-brand-cyan flex-shrink-0">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Email Us</div>
                    <a href="mailto:hello@techyfusion.com" className="hover:text-brand-cyan transition-colors text-sm font-semibold">
                ...
                <li className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Call Us</div>
                    <a href="tel:+18005550199" className="hover:text-brand-cyan transition-colors text-sm font-semibold">
                      +1 (800) 555-0199
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-brand-purple flex-shrink-0 mt-0.5">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Our Office</div>
                ...
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-brand-pink flex-shrink-0 mt-0.5">
                    <Clock className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 font-semibold uppercase tracking-wider">Business Hours</div>
            ...
            <div className="glass-card rounded-3xl p-8 text-center space-y-4">
              ...
              <div className="pt-2">
                <Link
                  href="/book"
                  className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-gradient-to-r from-brand-cyan to-brand-indigo text-white font-bold text-sm hover:opacity-90 transition-opacity"
                >
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10 relative overflow-hidden">
              {isSubmitted ? (
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1.5">
                      <label htmlFor="budget" className="text-xs text-slate-300 font-semibold uppercase tracking-wider">
                      ...
                      <select
                        ...
                        className="w-full bg-slate-950/80 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-cyan"
                      >
                    ...
                    <div className="space-y-1.5">
                      <label htmlFor="timeline" className="text-xs text-slate-300 font-semibold uppercase tracking-wider">
                        Expected Timeline
                      </label>
                      <select
                        id="timeline"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
        <div className="glass-card rounded-3xl p-4 overflow-hidden relative aspect-[21/9] w-full bg-slate-950 border border-white/10 flex items-center justify-center text-center">
          <div className="absolute inset-0 bg-[radial-gradient(#ffffff0a_1px,transparent_1px)] [background-size:16px_16px] pointer-events-none" />
          <div className="space-y-2 relative z-10 p-6">
            <div className="w-12 h-12 rounded-xl bg-brand-cyan/10 border border-brand-cyan/35 flex items-center justify-center text-brand-cyan mx-auto">
              <MapPin className="w-6 h-6" />
            </div>
            <h3 className="text-lg font-bold text-white">Silicon Valley Headquarters</h3>
            <p className="text-slate-400 text-xs">Latitude: 37.4419° N, Longitude: 122.1430° W</p>
          </div>
        </div>
      </section>
    </div>
